...
public class PermissionManager
{
    ...
    public void hasCameraAndSdPermission(PermissionCallback callbackToReturn)
    {
        hasPermission(callbackToReturn, new String[]{
                Manifest.permission.CAMERA, Manifest.permission.READ_EXTERNAL_STORAGE, Manifest.permission.WRITE_EXTERNAL_STORAGE, Manifest.permission.INTERNET, Manifest.permission.ACCESS_WIFI_STATE
        });
    }
